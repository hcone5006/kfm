...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '13px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '33px', 'lineheight' => '33px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
			...
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#e64c3c'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '25px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '84px', 'lineheight' => '84px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '20px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#2e2e2e'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Roboto, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
		return $options;
	}
}
?>